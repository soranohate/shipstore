...
cssclasses:
  - noyaml
  - noprop
link: https://www.notion.so/StartPage-37ac04351f494965807248bf134609c8
notionID: 37ac0435-1f49-4965-8072-48bf134609c8
---
```dataviewjs
let setting = {};
...
table without id 
link(file.name) as 日期, 总结 AS 每日总结
from #日常/日记 
where 总结 != null
sort file.name desc
limit 7
...
table without id 
link(file.name) as 笔记, 关于 AS 事件 , 收获 AS 收获 
from #Note 
WHERE contains(file.folder, "闪念笔记")
